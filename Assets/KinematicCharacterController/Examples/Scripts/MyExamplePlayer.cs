...
namespace KinematicCharacterController.Examples
{
    public class MyExamplePlayer: MonoBehaviour
    {
        ...
        scrollInput = 0f;
            ...
            MyCharacterCamera.UpdateWithInput(Time.deltaTime, scrollInput, lookInputVector);

            // Handle toggling zoom level
            if (Input.GetMouseButtonDown(1))
            {
                MyCharacterCamera.TargetDistance = (MyCharacterCamera.TargetDistance == 0f) ? MyCharacterCamera.DefaultDistance : 0f;
            }
        }
        ...
        private void HandleCharacterInput()
        {
            ...
            characterInputs.CameraRotation = MyCharacterCamera.Transform.rotation;
