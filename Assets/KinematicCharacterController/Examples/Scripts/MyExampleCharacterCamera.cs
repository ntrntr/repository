...
{
    public class MyExampleCharacterCamera:MonoBehaviour
    {
        [Header("Framing")]
        ...
        public ExampleProneCC FollowCharacter { get; set; }
        ...
        public void SetFollowCharacter(ExampleProneCC character)
        {
